    ...
    <div className="about-page">
      ...
      <div className="about-hero">
        <div className="about-hero-content">
          ...
          <h1>
            Connecting the <span>Conestoga</span> Community
          </h1>
      ...
      <section className="about-section about-mission">
        <div className="about-container">
          ...
          <p>
            Conestoga College students and alumni had no central hub to stay
            connected after graduation. Volunteer opportunities were scattered,
            mentorship was informal, and college news required visiting multiple
            pages. SSI Portal solves all of this in one place — a premium,
            modern platform built by students, for students.
          </p>
        </div>
      </section>
            ...
            {[
              {
                number: "3",
                label: "User Roles",
                sub: "Student · Alumni · Admin",
              },
              {
                number: "14+",
                label: "Pages Built",
                sub: "Full responsive UI",
              },
              {
                number: "8",
                label: "MongoDB Collections",
                sub: "Live cloud database",
              },
              {
                number: "1",
                label: "Real-time Hub",
                sub: "SignalR WebSocket chat",
              },
            ].map((stat, i) => (
      ...
      <section className="about-section about-team">
        <div className="about-container">
          ...
          <p className="about-team-sub">
            A team of Conestoga College students who designed, built, and
            delivered this platform as part of the SSI Capstone Project.
          </p>
          <div className="about-team-grid">
            {[
              ...
              <div className="about-team-card" key={i}>
                <div className="about-team-avatar">{m.name.charAt(0)}</div>
      ...
      <section className="about-cta">
        <div className="about-container">
          ...
          <p>
            Join the SSI community today and connect with students and alumni
            across Conestoga College.
          </p>
          <div className="about-hero-btns">
            <button
              className="about-btn-primary"
